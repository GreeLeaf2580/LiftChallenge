...
execute as @a[scores={section=!0}] at @s if entity @s[y=5,dy=-80] run function lib/level/items/reset
...
execute as @a[scores={section=!0}] at @s if block ~~2~ air [] if score timeline time matches 100.. if score timeline active matches 2 run function lib/level/items/reset