...
execute if score @s levitation matches 2 run tellraw @s { "rawtext": [{ "translate": "tell.effect" },{ "translate": "tell.levitation", "with": ["","0:00"] } ] }

execute if score @s levitation matches 1 run effect @s levitation 9999 5 true
execute if score @s levitation matches 1 run tellraw @s { "rawtext": [{ "translate": "tell.effect" },{ "translate": "tell.levitation", "with": ["VI","inf"] } ] }