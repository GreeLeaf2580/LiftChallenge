...
execute positioned 266 7 -98 unless block ~~-1~ redstone_wire ["redstone_signal"=0] as @p run tp @s 273 10 -112
execute positioned 297 10 -86 unless block ~~-1~ redstone_wire ["redstone_signal"=0] as @p run tp @s 273 10 -112