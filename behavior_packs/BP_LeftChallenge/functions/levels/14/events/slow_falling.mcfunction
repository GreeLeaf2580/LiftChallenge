execute if score @s slow_falling matches 2 run effect @s slow_falling 5 0 true
execute if score @s slow_falling matches 2 run tellraw @s { "rawtext": [{ "translate": "tell.slow_falling", "with": ["","0:05"] } ] }
